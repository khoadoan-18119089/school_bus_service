...
class FormControllerBloc extends Bloc<FormControllerEvent, bool>
    with FormControllerMixin {
  FormControllerBloc() : super(false) {
...
mixin FormControllerMixin on Bloc<FormControllerEvent, bool> {
